...
# Confirm the amount of kittens that the cat had
# Make a list of friends who i want to give kittens to
# Make a list of the kitten's names
# Confirm that each kitten is cute
# Show message that the kitten is ready for adoption